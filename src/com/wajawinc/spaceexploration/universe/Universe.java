...
import com.wajawinc.spaceexploration.universe.generator.Noise;
 ...
 * 
 * To support an infinite universe, the Universe is divided into cubes of space,
 * so our Noise class can generate n
 *
 */
public class Universe {
	...
	public void update(Player p) {
		...
		universeGridLocation.x = (float) Math.round(playerPos.x / UNIVERSE_DIVISION_SIZE);
		universeGridLocation.y = (float) Math.round(playerPos.y / UNIVERSE_DIVISION_SIZE);
		universeGridLocation.z = (float) Math.round(playerPos.z / UNIVERSE_DIVISION_SIZE);
